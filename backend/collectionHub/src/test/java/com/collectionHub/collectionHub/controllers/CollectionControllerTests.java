...
class CollectionControllerTests{
    ...
    //    mockMvc.perform(post("/addToCollections").contentType(MediaType.APPLICATION_JSON).content(
    //        "{collection, name: \"name\", series: \"series\", number: 1, dateReleased: \"date\", dateOfAcquisition: \"data\", productionRun: 1}"
